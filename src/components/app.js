    ...
    return (<div>
      ...
      <nav className="navbar fixed-top navbar-expand-lg navbar-dark py-3" style={{}}>
        ...
        <a className="navbar-brand" href="/">
          <img className="pagelogo" style={{ display: "none", width: "50px", marginTop: "-10px", height: "40px", objectFit: "cover", marginBottom: "0px" }} src={logo} alt="Family Harvest Church Logo" />
